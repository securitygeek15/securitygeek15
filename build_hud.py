...
def build_svg(is_dark):
    ...
    for idx, line in enumerate(art_lines):
        art_svg += f'<tspan x="450" y="{170 + idx * 8.6}">{line}</tspan>\n'
...
<!-- Top Header Info -->
<text x="25" y="26" class="micro-text">SYS.INIT // BLACK_AND_WHITE_ASCII</text>
...
if __name__ == '__main__':
    build_svg(True)
    build_svg(False)
    print("Minimal ASCII HUD SVGs generated successfully!")
